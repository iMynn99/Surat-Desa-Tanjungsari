          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo text-center">
                ...
                <div class="titleLogo mt-5">Balai Desa Cinta Rakyat</div>
              </div>
              <h6 class="text-center">LOGIN PEGAWAI</h6>
              <form method="POST" class="pt-3">
                <div class="form-group">
                  <select name="hak_akses" id="" class="form-control text-uppercase">
                    <option value="" selected="selected">Login sebagai</option>
                    <?php
                    $SQL = "SELECT * FROM data_user WHERE hak_akses='Staf'";
                ...
                <div class="mb-2">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="<?= $url_index; ?>">BATAL</a>
                </div>
