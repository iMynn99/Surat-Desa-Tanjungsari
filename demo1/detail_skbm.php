...
<?php
	if(isset($_GET['id_request_skbm'])){
		...
		$sql = "SELECT * FROM data_request_skbm natural join data_user WHERE id_request_skbm='$id_request_skbm'";
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="form-group">
                            ...
                            <a href="?halaman=sudah_acc_skbm" class="btn btn-info btn-border btn-round btn-sm">
                                Batal
                            </a>
                        </div>
                        <!-- <a href="cetak_skbm.php?id_request_skbm=<?php echo $id;?>" target="_blank" class="btn btn-info btn-border btn-round btn-sm">
												<span class="btn-label">
...
<?php
	if(isset($_POST['ubah'])){
		...
		if($query==1){
			$keterangan = $_POST['keterangan'];
			$ubah = "UPDATE data_request_skbm SET
		keterangan='$keterangan' WHERE id_request_skbm='$id_request_skbm'";
		...
		if($quey==1){
			...
			echo '<meta http-equiv="refresh" content="3; url=?halaman=detail_skbm">';
		  }
	}
?>