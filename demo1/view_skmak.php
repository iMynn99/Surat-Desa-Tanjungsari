...
<?php
if (isset($_GET['id_request_skmak'])) {
    $id = $_GET['id_request_skmak'];
    $id_ajuan = $_GET['id_request_skmak'];
    $sql = "SELECT * FROM data_request_skmak natural join data_user WHERE id_request_skmak='$id'";
    $query = mysqli_query($konek, $sql);
    $data = mysqli_fetch_array($query, MYSQLI_BOTH);
    $id = $data['id_request_skmak'];
    $nik = $data['nik'];
    $nama = $data['nama'];
    ...
    $acc = $data['acc'];
    $no_surat = $data['id_request_skmak'];
    $no_suratdb = $data['id_request_skmak'];
    if ($no_surat == "") {
                    ...
                    <div class="card-tools">
                        ...
                        if (isset($_POST['ttd'])) {
                            ...
                            if ($no_surat == "") {
                                ...
                                echo '<meta http-equiv="refresh" content="3; url=?halaman=view_skmak&id_request_skmak=' . $id_ajuan . '">';
                            } else {
                                $update = mysqli_query($konek, "UPDATE data_request_skmak SET no_surat='$no_surat' WHERE id_request_skmak=$id");
                                if ($update) {
                                    ...
                                    echo '<meta http-equiv="refresh" content="3; url=?halaman=view_skmak">';
                                }
                            }
                            ...
                            if ($no_suratdb == "") {
                                ...
                                $update2 = mysqli_query($konek, "UPDATE data_request_skmak SET status=2, acc='$tgl', keterangan='$ket' WHERE id_request_skmak=$id");
                                if ($update2) {
                ...
                <div class="card-body p-5">
                    <div class="cetak-surat p-5">
                        <table border="1" align="center">
                            ...
                            <br>
                            <center>
                                <font size="4"><b><u>SURAT KETERANGAN MASIH AKTIF KERJA</u></b></font><br>
                            ...
                            <table style="margin-left: 70px;" cellspacing="5" cellpadding="2">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        Bahwa Orang tersebut benar Perangkat Desa Tanjungsari dan berstatus masih aktif
                                        bekerja
                                    </td>
                                </tr>
                            </table>
