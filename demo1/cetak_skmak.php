...
<head>
    <meta charset="UTF-8">
    <title>Surat Keterangan Masih Aktif Kerja</title>
</head>
...
<body style="font-family: 'Times New Roman', Times, serif;">
    ...
    <table style="margin-left: 70px;" cellspacing="5" cellpadding="2">
        ...
        <tr>
            ...
            <td>:</td>
            <td>
                Bahwa Orang tersebut benar Perangkat<br>
                Desa Tanjungsari Jabatan Kadus Dukuh<br>
                Serang Kidul dan berstatus masih aktif bekerja.
            </td>
        </tr>
    </table>
