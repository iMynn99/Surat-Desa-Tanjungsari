...
if (isset($_GET['id_request_skbm'])) {
    ...
    $id_ajuan = $_GET['id_request_skbm'];
    $sql = "SELECT * FROM data_request_skbm natural join data_user WHERE id_request_skbm='$id'";
    ...
    $acc = $data['acc'];
    $no_surat = $data['id_request_skbm'];
    $no_suratdb = $data['id_request_skbm'];
    if ($no_surat == "") {
                    ...
                    <div class="card-tools">
                        ...
                        if (isset($_POST['ttd'])) {
                            ...
                            if ($no_surat == "") {
                                ...
                                echo '<meta http-equiv="refresh" content="3; url=?halaman=view_skbm&id_request_skbm=' . $id_ajuan . '">';
                            } else {
                                $update = mysqli_query($konek, "UPDATE data_request_skbm SET no_surat='$no_surat' WHERE id_request_skbm=$id");
                                if ($update) {
                                    ...
                                    echo '<meta http-equiv="refresh" content="3; url=?halaman=view_skbm">';
                                }
                            }
                            ...
                            if ($no_suratdb == "") {
                                ...
                                $update2 = mysqli_query($konek, "UPDATE data_request_skbm SET status=2, acc='$tgl', keterangan='$ket' WHERE id_request_skbm=$id");
                                if ($update2) {
                                    echo "<script language='javascript'>swal('Selamat...', 'ACC Berhasil', 'success');</script>";
                                    echo '<meta http-equiv="refresh" content="3; url=?halaman=sudah_acc_skbm">';
                                } else {
                                    echo "<script language='javascript'>swal('Gagal...', 'ACC Lurah Gagal', 'error');</script>";
                                    echo '<meta http-equiv="refresh" content="3; url=?halaman=view_skbm">';
                                }
                ...
                <div class="card-body p-5">
                    <div class="cetak-surat p-5">
                        <table border="1" align="center">
                            ...
                            <br>
                            <center>
                                <font size="4"><b><u>SURAT KETERANGAN BELUM MENIKAH</u></b></font><br>
                            ...
                            <table style="margin-left: 70px;" cellspacing="5" cellpadding="2">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        Bahwa Orang tersebut benar-benar<br>
                                        belum menikah dan masih berstatus JEJAKA
                                    </td>
                                </tr>
                            </table>
