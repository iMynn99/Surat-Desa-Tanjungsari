...
<?php
	if(isset($_GET['id_request_skmak'])){
		$id_request_skmak=$_GET['id_request_skmak'];
		$sql = "SELECT * FROM data_request_skmak natural join data_user WHERE id_request_skmak='$id_request_skmak'";
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="form-group">
                            ...
                            <a href="?halaman=sudah_acc_skmak" class="btn btn-info btn-border btn-round btn-sm">
                                Batal
                            </a>
                        </div>
                        <!-- <a href="cetak_skmak.php?id_request_skmak=<?php echo $id;?>" target="_blank" class="btn btn-info btn-border btn-round btn-sm">
												<span class="btn-label">
...
<?php
	if(isset($_POST['ubah'])){
		...
		if($query==1){
			$keterangan = $_POST['keterangan'];
			$ubah = "UPDATE data_request_skmak SET
		keterangan='$keterangan' WHERE id_request_skmak='$id_request_skmak'";
		...
		if($quey==1){
			...
			echo '<meta http-equiv="refresh" content="3; url=?halaman=detail_skmak">';
		  }
	}
?>