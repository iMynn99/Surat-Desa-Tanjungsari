            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="fw-bold text-uppercase">belum acc request surat keterangan belum menikah</h4>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td>
															...
															<div class="form-button-action">
																<a type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Lihat Surat" href="?halaman=detail_skbm&id_request_skbm=<?= $id_request_skbm; ?>">
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <a type="button" data-toggle="tooltip" title=""
                                                    ...
                                                    href="?halaman=view_skbm&id_request_skbm=<?= $id_request_skbm; ?>">
                                                    <i class="fa fa-edit"></i></a>
                                            </div>
                                        </td>
                                    </tr>
