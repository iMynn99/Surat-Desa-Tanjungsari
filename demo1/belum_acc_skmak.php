            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="fw-bold text-uppercase">belum acc request surat keterangan masih aktif kerja</h4>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td>
															...
															<div class="form-button-action">
																<a type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Lihat Surat" href="?halaman=detail_skmak&id_request_skmak=<?= $id_request_skmak; ?>">
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <a type="button" data-toggle="tooltip" title=""
                                                    ...
                                                    href="?halaman=view_skmak&id_request_skmak=<?= $id_request_skmak; ?>">
                                                    <i class="fa fa-edit"></i></a>
                                            </div>
                                        </td>
                                    </tr>
