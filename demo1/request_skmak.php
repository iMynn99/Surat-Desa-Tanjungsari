            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">FORM TAMBAH REQUEST SKMAK</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
...
if (isset($_POST['kirim'])) {
	...
	$file_kk = rand() . ".jpg";
	$sql = "INSERT INTO data_request_skmak (nik,scan_ktp,scan_kk,keperluan) VALUES ('$nik','$file_ktp','$file_kk','$keperluan')";
	...
	if ($query) {
		...
		echo '<meta http-equiv="refresh" content="3; url=?halaman=request_skmak">';
	}
}
